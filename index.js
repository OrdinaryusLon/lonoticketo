...
.setColor("127896")
.setAuthor({ name: `ClubPenguin.V2 | Destek Sistemi`, iconURL: as.guild.iconURL({ dynamic: true }) })
...
.addFields(
     ...
     { name: "☢️ Bot Çalıntı Bildirimi ", value: "Biri botumuzu çaldıysa onu sunucudan yasaklatabilirsin.", inline: true },
     { name: "🎉 Çekiliş Kazandım  ", value: "Bir çekiliş kazandıysan ödülünü burdan alacaksın.", inline: true },
 )
 .setThumbnail("https://cdn.discordapp.com/attachments/1068960086304763964/1069326220682076291/images.png")
 .setFooter({ text: "Bot destek hakkında yardım almak için Dr.Lon#0707 özelden mesaj atın", iconURL: "https://cdn.discordapp.com/attachments/1068960086304763964/1069326220682076291/images.rar" })
...
const butonlar = ["Çekiliş Kazandım","Bot Çalıntı Bildirimi","Kullanıcı Bildirimi"]
...
const embed = new EmbedBuilder()
.setAuthor({name: "ClubPenguin.V2 - Destek Sistemi!", iconURL: interaction.guild.iconURL()})
